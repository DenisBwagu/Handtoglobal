...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number"><?php echo $stats['used'] ?? 0; ?></div>
                <div class="stat-label">Used Codes</div>
            </div>
            <div class="stat-card">
                <div class="stat-number">$<?php echo number_format($stats['total_bonus'] ?? 0, 2); ?></div>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <?php if (!$code['is_used'] && (!$code['expires_at'] || strtotime($code['expires_at']) > time())): ?>
                                        <a href="invitation_codes.php?deactivate=<?php echo $code['id']; ?>" 
                                           class="btn btn-warning btn-sm" 
                                           onclick="return confirm('Are you sure you want to deactivate this code?')">
                                            <i class="fas fa-pause"></i> Deactivate
                                        </a>
                                    <?php endif; ?>
                                    <a href="invitation_codes.php?delete=<?php echo $code['id']; ?>" 
