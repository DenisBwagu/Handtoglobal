...
<head>
    ...
    <title>Create Contact - HandToGlobal Admin</title>
...
<body>
    ...
    <div class="topbar">
        <div class="topbar-left">
            <div class="topbar-title">Create Contact</div>
        </div>
            ...
            <div class="form-card">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" name="create_contact" class="btn btn-primary">Create Contact</button>
                    </div>
                </form>
            </div>
        </div>
