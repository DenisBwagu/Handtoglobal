...
// Read current language helpers file
$current_helpers = file_get_contents(__DIR__ . '/includes/language_helpers.php');

// Create improved version that removes circular dependency
$improved_helpers = '<?php
/**
...
if (!function_exists(\'get_current_language\')) {
    function get_current_language() {
        ...
        if (function_exists(\'get_setting\')) {
            $setting_value = get_setting($contextKey, \'english\');
            if (!empty($setting_value)) {
                return normalize_language_code($setting_value);
            }
        }
...
if (file_put_contents(__DIR__ . '/includes/language_helpers.php', $improved_helpers)) {
