...
if (isset($_POST['create_contact'])) {
    ...
    if (empty($name)) {
        ...
        try {
            // Insert contact
            $stmt = $conn->prepare("
                INSERT INTO contacts (name, phone, email, employee_id, status, registered, notes) 
                VALUES (?, ?, ?, ?, ?, ?, ?)
            ");
            $stmt->execute([$name, $phone, $email, $employee_id, $status, $registered, $notes]);
            
            $msg = "Contact created successfully!";
            
            // Redirect to contacts list
            if (empty($error)) {
                redirect('contacts.php?msg=' . urlencode('Contact created successfully!'));
            }
...
<head>
    ...
    <title>Create Contact - <?php echo htmlspecialchars(get_site_name()); ?> Admin</title>
...
<!-- MANAGEMENT Section -->
        ...
        <div class="main-content">
            ...
            <div class="breadcrumb">
                <a href="contacts.php">Contacts</a> > Create
            </div>
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="employee_id" class="form-control-select">
                            ...
                            <?php foreach ($employees as $employee): ?>
                                <option value="<?php echo $employee['id']; ?>" <?php echo (($_POST['employee_id'] ?? '') == $employee['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control-select" required>
                            <?php foreach ($statuses as $status): ?>
                                <option value="<?php echo $status; ?>" <?php echo (($_POST['status'] ?? 'new') == $status) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            <input type="checkbox" name="registered" class="checkbox-input" <?php echo (isset($_POST['registered'])) ? 'checked' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" class="form-control-textarea"><?php echo htmlspecialchars($_POST['notes'] ?? ''); ?></textarea>
                    </div>
                    
                    <!-- Buttons -->
                    <div class="form-group">
                        <a href="contacts.php" class="btn btn-secondary"><?php echo __t('cancel', 'Cancel'); ?></a>
                        <button type="submit" name="create_contact" class="btn btn-primary"><?php echo __t('create_contact', 'Create Contact'); ?></button>
                    </div>
                </form>
            </div>
        </div>
