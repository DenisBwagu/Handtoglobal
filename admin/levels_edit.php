...
<head>
    ...
    <title>Edit Level - HandToGlobal Admin</title>
                    ...
                    <form method="POST">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="order" class="form-input" value="<?php echo $level['sort_order']; ?>" required>
                            </div>
                        </div>
                        
                        <label class="form-label">Icon</label>
                        <div class="icon-grid">
                            <div class="icon-card <?php echo $level['icon'] === 'medal-bronze' ? 'selected' : ''; ?>" onclick="selectIcon('medal-bronze')">
                                <i class="fas fa-medal"></i>
                                <div class="icon-label">Bronze Medal</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'medal-silver' ? 'selected' : ''; ?>" onclick="selectIcon('medal-silver')">
                                <i class="fas fa-medal"></i>
                                <div class="icon-label">Silver Medal</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'medal-gold' ? 'selected' : ''; ?>" onclick="selectIcon('medal-gold')">
                                <i class="fas fa-medal"></i>
                                <div class="icon-label">Gold Medal</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'trophy' ? 'selected' : ''; ?>" onclick="selectIcon('trophy')">
                                <i class="fas fa-trophy"></i>
                                <div class="icon-label">Trophy</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'crown' ? 'selected' : ''; ?>" onclick="selectIcon('crown')">
                                <i class="fas fa-crown"></i>
                                <div class="icon-label">Crown</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'star' ? 'selected' : ''; ?>" onclick="selectIcon('star')">
                                <i class="fas fa-star"></i>
                                <div class="icon-label">Star</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'shield' ? 'selected' : ''; ?>" onclick="selectIcon('shield')">
                                <i class="fas fa-shield-alt"></i>
                                <div class="icon-label">Shield</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'gem' ? 'selected' : ''; ?>" onclick="selectIcon('gem')">
                                <i class="fas fa-gem"></i>
                                <div class="icon-label">Gem</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'fire' ? 'selected' : ''; ?>" onclick="selectIcon('fire')">
                                <i class="fas fa-fire"></i>
                                <div class="icon-label">Fire</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'lightning' ? 'selected' : ''; ?>" onclick="selectIcon('lightning')">
                                <i class="fas fa-bolt"></i>
                                <div class="icon-label">Lightning</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'rocket' ? 'selected' : ''; ?>" onclick="selectIcon('rocket')">
                                <i class="fas fa-rocket"></i>
                                <div class="icon-label">Rocket</div>
                            </div>
                            <div class="icon-card <?php echo $level['icon'] === 'diamond' ? 'selected' : ''; ?>" onclick="selectIcon('diamond')">
                                <i class="fas fa-gem"></i>
                                <div class="icon-label">Diamond</div>
                            </div>
                        </div>
                        
                        <input type="hidden" name="icon" id="selected_icon" value="<?php echo htmlspecialchars($level['icon'] ?? 'medal-bronze'); ?>">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="reward" class="form-input" value="<?php echo $level['task_reward']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">TasksCount</label>
                                <input type="number" name="tasks_count" class="form-input" value="<?php echo $level['daily_task_limit']; ?>" required>
                            </div>
                        </div>
                        
                        <div class="form-checkbox">
                            <input type="checkbox" name="requires_deposit" id="requires_deposit" <?php echo $level['deposit_amount'] > 0 ? 'checked' : ''; ?>>
                            <label for="requires_deposit">RequiresDeposit</label>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">DepositAmount</label>
                            <input type="number" step="0.01" name="deposit_amount" class="form-input" value="<?php echo $level['deposit_amount']; ?>">
                        </div>
                        
                        <div class="form-checkbox">
                            <input type="checkbox" name="is_active" id="is_active" <?php echo $level['is_active'] ? 'checked' : ''; ?>>
