...
<div class="app">
  <aside class="sidebar">
    <div class="brand">
      ...
      <div>
        ...
        <p class="brandSub">Transactions</p>
      </div>
    </div>
    <div class="nav">
  ...
  <main class="content">
    <div class="wrap">
      <div class="top">
        <div>
          <h2 class="hTitle">Transactions</h2>
          <div class="muted">
            <?php echo htmlspecialchars($user['fullname']); ?> •
            Balance: <strong><?php echo htmlspecialchars($user['balance']); ?> USDT</strong> •
      ...
      <div class="panel">
        <div class="tabs">
          <button class="tab active" onclick="showTab('earn')">Earnings</button>
          <button class="tab" onclick="showTab('dep')">Deposits</button>
          <button class="tab" onclick="showTab('wd')">Withdrawals</button>
        </div>

        <div id="earn" style="margin-top:12px">
          <?php echo badge("Task Earnings"); ?>
          <?php if(empty($earnings)){ ?>
            <div class="muted">No earnings yet.</div>
          <?php } else { ?>
            <table>
              <tr><th>Date</th><th>Level</th><th>Task</th><th>Reward</th></tr>
