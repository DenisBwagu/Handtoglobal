<?php
/**
 * Standardized PHP Template for HandToGlobal Project
 * This template ensures proper syntax structure and prevents common errors
 */

// Always start with this structure for any PHP file that needs database operations

// 1. Include required files first
require_once 'config.php';

// 2. Handle authentication redirects (if applicable)
if (isLoggedIn()) {
...
// 4. Database connection check (for non-POST requests)
